...
def render_health_checks(df, global_services=None):
    ...
    pivot_df = heat_df.pivot_table(index="scenario_id", columns="component_name", values=metric_col)
    ...
    worst_k = st.number_input("Top K Slowest Components:", min_value=1, value=10, max_value=50, key="worst_k")
